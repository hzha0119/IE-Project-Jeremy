...
switch (category) {
    case "Low":
        ...
        document.getElementById("analysis").innerHTML =
            `Congratulation! Your body is in fit condition which means your healthy habit is well in your life.`;
    ...
    case "High":
        ...
        document.getElementById("recommendation").innerHTML = 
            `We strongly recommend you to make an appointment with a doctor ASAP. To find a GP for HPV infection, 
...
saveHighScore = e => {
    ...
    const score = {
        ...
        date: ddd.toLocaleString('en-AU', { timeZone: 'Australia/Melbourne' }),
